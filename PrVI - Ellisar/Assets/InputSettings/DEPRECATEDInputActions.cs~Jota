// GENERATED AUTOMATICALLY FROM 'Assets/Moving On.inputactions'
...
public class DEPRECATEDInputActions : IInputActionCollection, IDisposable
{
    public InputActionAsset asset { get; }
    public DEPRECATEDInputActions()
    {
    ...
    {
        private DEPRECATEDInputActions m_Wrapper;
        public PlayerActions(DEPRECATEDInputActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private DEPRECATEDInputActions m_Wrapper;
        public UIActions(DEPRECATEDInputActions wrapper) { m_Wrapper = wrapper; }
